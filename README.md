...
- Run the [Release workflow](https://github.com/bonitasoft/bonita-connector-document-converter/actions/workflows/release.yml), set the version to release as parameter
